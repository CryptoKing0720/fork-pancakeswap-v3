...
const publicSubgraphParams = {
  ...
  noderealApiKey: '253a34e4fcf64cb18da553295199810d',
}
...
export const STABLESWAP_SUBGRAPHS = {
  ...
  [ChainId.HOLESKY]: 'https://api.studio.thegraph.com/query/70381/holesky-exchange-stableswap/v1.0.5',
}
...
export function getV3Subgraphs({ noderealApiKey }: SubgraphParams) {
  return {
    ...
    [ChainId.HOLESKY]: 'https://api.studio.thegraph.com/query/70381/holesky-exchange-v3/v1.1.5',
...
export function getV2Subgraphs({ noderealApiKey }: SubgraphParams) {
  return {
    ...
    [ChainId.HOLESKY]: 'https://api.studio.thegraph.com/query/70381/holesky-exchange-v2/v1.0.2',
  }
}
...
export function getBlocksSubgraphs({ noderealApiKey }: SubgraphParams) {
  return {
    ...
    [ChainId.HOLESKY]: 'https://api.studio.thegraph.com/query/70381/holesky-blocks/v1.1.0',
  }
}
